...
public class EventCJParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("EventCJ");
  ...
  { 
    EventCJParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EventCJParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EventCJParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EventCJParseControllerGenerated.class);
    }
  ...
  { 
    return EventCJParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
