...
public class EventCJParseController extends DynamicParseController 
{ 
  ...
  { 
    try
    { 
      InputStream descriptorStream = EventCJParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EventCJParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EventCJParseController.class);
    }
